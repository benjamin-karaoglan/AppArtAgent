...
class DVFImporter:
    ...
    def upsert_batch(self, batch_df: pd.DataFrame, source_file: str, source_file_hash: str) -> dict:
        ...
        try:
            ...
            return {
                "inserted": inserted,
                "updated": 0,
            }  # Simplified - PostgreSQL doesn't easily report updates
    ...
    def import_file(self, file_path: str, data_year: int, force: bool = False) -> DVFImport:
        ...
        try:
            ...
            import_record.skipped_records = import_record.total_records - (
            ...
            logger.info(
                f"  Throughput: {import_record.total_records / import_record.duration_seconds:.0f} records/sec"
            )
