...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_dvf_imports_year_status", "dvf_imports", ["data_year", "status"], unique=False
    )
    ...
    op.create_index(
        "idx_dvf_date_postal_type",
        "dvf_records",
        ["sale_date", "postal_code", "property_type"],
        unique=False,
    )
    op.create_index(
        "idx_dvf_postal_type_address",
        "dvf_records",
        ["postal_code", "property_type", "address"],
        unique=False,
    )
    op.create_index(
        "idx_dvf_postal_type_surface",
        "dvf_records",
        ["postal_code", "property_type", "surface_area"],
        unique=False,
    )
    op.create_index(
        "idx_dvf_price_per_sqm",
        "dvf_records",
        ["price_per_sqm"],
        unique=False,
    ...
    op.create_index(
        op.f("ix_dvf_records_import_batch_id"), "dvf_records", ["import_batch_id"], unique=False
    )
    op.create_index(
        op.f("ix_dvf_records_postal_code"), "dvf_records", ["postal_code"], unique=False
    )
    op.create_index(op.f("ix_dvf_records_sale_date"), "dvf_records", ["sale_date"], unique=False)
    op.create_index(
        op.f("ix_dvf_records_transaction_group_id"),
        "dvf_records",
...
def downgrade() -> None:
    ...
    op.drop_index(
        "idx_dvf_price_per_sqm", table_name="dvf_records", postgresql_where="price_per_sqm > 0"
    )
